...
"""
F1_Score computes various F1 scores (micro, macro, samples, and weighted) for a multi-class classification problem.
f1_score combines precision and recall into a single value, providing a balance between these two metrics 
...
It is particularly useful when dealing with imbalanced datasets, where the number of negative samples significantly outweighs the positive samples.
"""
...
def compute_metric(args, metric):
