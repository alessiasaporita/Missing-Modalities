...
def compute_mmimdb(pl_module, batch):
    ...
    # Obtain ground truth labels and convert them to a tensor
    ...
    # Compute custom loss using the phase-specific loss function
    loss = getattr(pl_module, f"{phase}_mmimdb_loss")(ret["mmimdb_loss"])

    # Compute F1 scores using the phase-specific F1 score function
