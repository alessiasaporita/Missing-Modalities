...
def test(args):
    path: Path = Path(f"{args.root}/clip/classifier/{args.clip_model}/classifier_{args.model}_{args.dataset}_{args.fusion}_{args.missing_type}_{args.missing_ratio}_{args.batch_size}_{args.gc}/saved_models/{args.best_classifier}")
    path_metric: Path = Path(f'{args.data_output_root}metrics/clip/{args.clip_model}/{args.model}_{args.dataset}_{args.fusion}_{args.missing_type}_{args.missing_ratio}_{args.batch_size}_{args.gc}')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--input-size", default=768, choices=[768, 512], type=int)
    ...
    parser.add_argument("--best-classifier", default='classifier_19.pt', type=str)
    ...
    parser.add_argument("--missing-ratio", default=0, type=float)
